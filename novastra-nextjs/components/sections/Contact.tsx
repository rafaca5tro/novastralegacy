            ...
            <GlassCard className="p-8 h-full">
              ...
              <div className="mt-12 pt-8 border-t border-gray-700">
                ...
                <div className="flex items-center mb-4 justify-center">
                  <svg className="w-5 h-5 text-novastra-orange mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center mb-4 justify-center">
                  ...
                  <span className="text-gray-300">Global Sports Technology Services</span>
                </div>
                </div>
                
                <div className="mt-8 flex justify-center space-x-6">
                  <a href="https://www.instagram.com/novastralegacy" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-novastra-dark-gray hover:bg-novastra-orange flex items-center justify-center transition-colors duration-300">
                  ...
                  <a href="https://www.linkedin.com/company/novastralegacy" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-novastra-dark-gray hover:bg-novastra-orange flex items-center justify-center transition-colors duration-300">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                    </svg>
                  </a>
                  <a href="https://twitter.com/novastralegacy" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-novastra-dark-gray hover:bg-novastra-orange flex items-center justify-center transition-colors duration-300">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
